  ...
  return (
    <div className='category-main-banner'>
      ...
      <figure className='desktop'>
        <Image alt={banner.alt} src={banner.img} width={1350} height={315} priority={isFirst} loading="eager" />
      </figure>
      <figure className='mobile'>
        <Image alt={banner.alt} src={banner.img} fill priority={isFirst} loading="eager" />
      </figure>
    </div>
  );
}
